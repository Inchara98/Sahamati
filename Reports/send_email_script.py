...
def send_email(username, password, recipient_email):
    ...
    sender_email = username  # No need to decode
    receiver_email = recipient_email  # No need to decode
    ...
    with open('./Reports/homepage.html', 'rb') as f:
        attach = MIMEApplication(f.read(), _subtype="html")
        attach.add_header('Content-Disposition', 'attachment', filename="homepage.html")
        msg.attach(attach)
